...
-------------------------------------------------------------------------
File Description:
View file for the graph depicting temperature sensor data from a plant collection.
   ...
   function(Backbone, CJS, PlantModel, PlantCollection) {
      return Backbone.View.extend({
         ...
         render: function()
         {
             ...
             var tempVals = new Array(); // replace with an array of moisture values from collection

             // Grab data from collection
             this.collection.each(function(label) {
                lbls.push(label.get('timestamp'));
                tempVals.push(label.get('temp'));
            });
                ...
                datasets: [
                    {
                        ...
                        fillColor: "rgba(199, 22, 22, 0.5)",
                        strokeColor: "rgb(239, 64, 64)",
                        pointColor: "rgb(239, 64, 64)",
                        pointStrokeColor: "#fff",
                        pointHighlightFill: "#fff",
                        pointHighlightStroke: "rgb(239, 64, 64)",
                        data: tempVals
                    }
                ]
            };
